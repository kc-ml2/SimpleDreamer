...
encoder = Encoder(input_dim=1024, hidden_dim=256, latent_dim=128)
decoder = Decoder(latent_dim=128, hidden_dim = 256, output_dim = 1024)
...
class Dreamer:
    ...
    def dynamic_learning(self, data):
        ...
        x = data.embedded_observation.detach()
        ...
        self.writer.add_scalar(
            "vae_loss", loss, self.num_total_episode
        )
